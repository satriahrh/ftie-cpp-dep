// g++ -o bin/exp-f -std=c++17 ftie/*.h ftie/*.cpp experiment/tools.h experiment/tools.cpp experiment/f.cpp `libpng-config --ldflags` && ./bin/exp-f
#include "../ftie/ftie.h"
